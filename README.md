...
A repository-local "operating system" for agentic development in Claude Code, packaged as a Claude Code plugin (version `0.1.8`). It bundles task tracking, code/database knowledge graphs, lifecycle hooks, and a delegation-oriented set of agents and skills.
